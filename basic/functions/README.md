...
| ------------------------------------ | :--------------------: |
|WAP to find sum of two numbers|[code](5.c)|
|Write a code to print **area of circle** 3 time and your name 2 time. | [code](1.c)|
|WAP to find sum of two numbers. with return type, without arguments|[code](6.c)|
| WAP to print 1-10 in ascending order & 10-1 in descending order. |[code](2.c)|
